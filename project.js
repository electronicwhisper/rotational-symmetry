...
(function() {
  var App, Canvas, Editor, EditorTool, Geo, LayerManager, Model, Ref, Render, closestPointOnLineForPoint, intersectionPointForLines, makeElFromHTML, quadranceFromPointToPoint, reflectionOnLineForPoint, _base, _ref, _ref1,
  ...
  */
  ...
  Editor = (function() {
    ...
    Editor.prototype.drawPaletteTool = function(toolName, canvasEl) {
      ...
      if (toolName === "Select") {
        ...
        Render.drawPoint(canvas, p1);
        Render.drawPoint(canvas, p2);
        return Render.drawReflectionWreath(canvas, p1, p2);
      }
    };
  ...
  EditorTool.RotationWreath = (function() {
    ...
    RotationWreath.prototype.pointerMove = function(e) {
      ...
      if (!this.provisionalRotationWreath) {
        ...
        return this.editor.contextWreath.objects.push(this.provisionalRotationWreath);
      }
    };
  ...
  EditorTool.ReflectionWreath = (function() {
    function ReflectionWreath(editor) {
      this.editor = editor;
    ...
    ReflectionWreath.prototype.pointerMove = function(e) {
      var pointRef;
      if (!this.provisionalReflectionWreath) {
        pointRef = this.editor.startMove(e);
        this.provisionalReflectionWreath = new Model.ReflectionWreath(pointRef, null);
        return this.editor.contextWreath.objects.push(this.provisionalReflectionWreath);
      }
    };

    ReflectionWreath.prototype.pointerUp = function(e) {
      if (this.provisionalReflectionWreath) {
        if (!this.provisionalReflectionWreath.p2) {
          return this.provisionalReflectionWreath.p2 = this.editor.startMove(e);
        } else {
          this.provisionalReflectionWreath = null;
          return this.editor.endMove();
        }
    ...
    ReflectionWreath.prototype.pointerLeave = function(e) {
      if (this.provisionalReflectionWreath && !this.provisionalReflectionWreath.p2) {
        this.editor.removeObject(this.provisionalReflectionWreath);
        return this.provisionalReflectionWreath = null;
      }
    };

    return ReflectionWreath;
  ...
  intersectionPointForLines = function(p1, p2, p3, p4) {
    var d, na, nb, ua, ub, x, y;
    if (p1.x === p2.x && p1.y === p2.y) {
      return void 0;
    }
    if (p3.x === p4.x && p3.y === p3.y) {
      return void 0;
    }
  ...
  closestPointOnLineForPoint = function(p1, p2, p3) {
    var d, n, u, x, y;
    if (p1.x === p2.x && p1.y === p2.y) {
      return void 0;
    }
  ...
  quadranceFromPointToPoint = function(p1, p2) {
    var dx, dy;
    dx = p2.x - p1.x;
    dy = p2.y - p1.y;
    return dx * dx + dy * dy;
  ...
  reflectionOnLineForPoint = function(p1, p2, p3) {
    var dx, dy, p, x, y;
  ...
  */
  ...
  Model.ReflectionWreath = (function(_super) {
    __extends(ReflectionWreath, _super);

    ReflectionWreath.prototype.name = "Reflection Group";

    ReflectionWreath.prototype.points = function() {
      return [this.p1, this.p2];
    };

    function ReflectionWreath(p1, p2) {
      this.p1 = p1;
      this.p2 = p2;
      ReflectionWreath.__super__.constructor.call(this);
    }

    ReflectionWreath.prototype.ops = function() {
      return [1, -1];
    };

    ReflectionWreath.prototype.inverse = function(op) {
      return op;
    };

    ReflectionWreath.prototype.perform = function(op, point) {
      var _ref;
      if (op === -1) {
        return (_ref = reflectionOnLineForPoint(this.p1.evaluate(), this.p2.evaluate(), point)) != null ? _ref : point;
      } else {
        return point;
      }
    };
  ...
  */
  ...
  Render.drawReflectionWreath = function(canvas, p1, p2, opts) {
    ...
    start = (_ref = intersectionPointForLines(p1, p2, nw, ne)) != null ? _ref : intersectionPointForLines(p1, p2, nw, sw);
    end = (_ref1 = intersectionPointForLines(p1, p2, sw, se)) != null ? _ref1 : intersectionPointForLines(p1, p2, ne, se);
